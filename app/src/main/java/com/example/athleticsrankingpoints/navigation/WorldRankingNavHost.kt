...
fun WorldRankingNavHost(
  ...
  val lookUpViewModel: LookUpViewModel = getViewModel() //make sure you get the viewModel function from the koin lib
  ...
  androidx.navigation.compose.NavHost(
    ...
    composable(route = WorldRankingScreen.PointLookUp.name) {
      ...
      PointLookUpBody(lookUpViewModel = lookUpViewModel)
    }
